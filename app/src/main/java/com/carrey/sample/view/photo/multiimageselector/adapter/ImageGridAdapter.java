...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Context context, BitmapTools mBitmapTools, boolean showCamera){
    ...
    class ViewHolde {
        ...
        void bindData(final Image data){
            ...
            if(mItemSize > 0) {
                // 显示图片
                mBitmapTools.display(image,imageFile.toURI().toString(),mItemSize,mItemSize);
